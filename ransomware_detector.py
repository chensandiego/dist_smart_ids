...
MAX_FILE_OPERATIONS = 100  # Total file operations (read, write, create)
MAX_FILE_RENAMES = 10      # Number of file rename operations
MAX_FILE_DELETES = 10      # Number of file delete operations
...
SMB_ACTIVITY = defaultdict(lambda: {
    'timestamp': 0,
    'operations': 0,
    'renames': 0,
    'deletes': 0
...
def detect_ransomware_behavior():
    ...
    for ip, activity in list(SMB_ACTIVITY.items()):
        ...
        if (activity['operations'] > MAX_FILE_OPERATIONS or
            ...
            synthetic_pkt = IP(src=ip, dst="255.255.255.255")
...
if __name__ == '__main__':
    ...
    print("Ransomware detector module is running in standalone test mode.")
    ...
    for i in range(MAX_FILE_RENAMES + 1):
        ...
        pkt = IP(src=test_ip) / TCP(dport=445) / "SMB2...SET_INFO..."
